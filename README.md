...
- [microsoft/vscode-dev-containers](https://github.com/microsoft/vscode-dev-containers) ([v0.189.0](https://github.com/microsoft/vscode-dev-containers/releases/tag/v0.189.0), 1 day ago) - A repository of development container definitions for the VS Code Remote - Containers extension and GitHub Codespaces
- [Cyb3r-Jak3/actions-cloudflare-pages](https://github.com/Cyb3r-Jak3/actions-cloudflare-pages) ([v1.0.1](https://github.com/Cyb3r-Jak3/actions-cloudflare-pages/releases/tag/v1.0.1), 6 days ago) - Github Action for deploying to Cloudflare pages when needed.
...
- [dadulo3/awesome-opendirectories](https://github.com/dadulo3/awesome-opendirectories) - Websites for data hoarders - grouped by category (1 day ago)
