...
- [microsoft/vscode-dev-containers](https://github.com/microsoft/vscode-dev-containers) ([v0.229.0](https://github.com/microsoft/vscode-dev-containers/releases/tag/v0.229.0), 3 days ago) - A repository of development container definitions for the VS Code Remote - Containers extension and GitHub Codespaces
- [coredns/coredns](https://github.com/coredns/coredns) ([v1.9.1](https://github.com/coredns/coredns/releases/tag/v1.9.1), 2 weeks ago) - CoreDNS is a DNS server that chains plugins
...
- [Cyb3r-Jak3/workers-serverless-api](https://github.com/Cyb3r-Jak3/workers-serverless-api) -  (6 days ago)
